      ...
      <div className="panel">
        ...
        <div className="panel-body">
          <p className="fs-14 pb-1 mb-10">
            Use <code>nested-sortable-handle</code> class to list-group class to
            set a nested list with sortable items.
          </p>
          <div
            id="nestableListWithHandle"
            className="list-group nested-sortable-handle"
          >
