    ...
    <form>
      <div className="row align-items-center g-3 mb-3">
        <label className="col-md-2 col-form-label col-form-label-sm">
          SKU
          <span
            className="btn-flush fs-14 ms-1 ms-1"
      ...
      <div className="row align-items-center g-3 mb-3">
        <label className="col-md-2 col-form-label col-form-label-sm">
          Stock Status
          <span
            className="btn-flush fs-14 ms-1"
            data-tooltip-id="my-tooltip"
            data-tooltip-content="Lorem Ipsum is simply dummy text."
          >
            <i className="fa-solid fa-circle-question"></i>
      ...
      <div className="row align-items-center g-3 mb-3">
        ...
        <div className="col-md-10">
          <input type="number" className="form-control" id="lowStockWarning" />
        </div>
      </div>
      <div className="row align-items-center g-3 mb-3">
        <label
          htmlFor="showStockQuantity"
          className="col-md-2 col-8 col-form-label col-form-label-sm"
        >
          Show Stock Quantity
        </label>
