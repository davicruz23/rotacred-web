...
const CategoryDropdowns = () => {
  const [subDropdown, setSubDropdown] = useState<SubDropdownState>({
    showFinance: false,
  ...
  return (
    <div className="product-categories">
      <div className="cat-group">
        ...
        <div
          className={`sub-cat-group ${subDropdown.showFinance ? "" : "d-none"}`}
        >
          <div className="form-check">
            <input
