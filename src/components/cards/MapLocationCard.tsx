    ...
    <div className="card bg-white pb-0 full-height">
      <div className="row">
        <div className="col-12">
          <div className="card-header-area map-location-card-header pb-2 border-bottom flex-wrap mb-4">
            <div>
        ...
        <div className="col-12">
          <div className="map-location-wrap d-flex align-items-center flex-wrap overflow-hidden">
